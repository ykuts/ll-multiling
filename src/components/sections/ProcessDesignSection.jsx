        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-6 lg:gap-4">
          ...
          <div className="bg-white text-primary rounded-lg p-4 w-full lg:w-72 h-96 relative flex flex-col">
            <div className="text-center mb-3">
              <h3 className="text-base font-bold text-primary mb-1">NEEDS</h3>
              <h3 className="text-base font-bold text-primary">ASSESSMENT</h3>
            </div>
          ...
          <div className="bg-white text-primary rounded-lg p-4 w-full lg:w-72 h-96 relative flex flex-col">
            <div className="text-center mb-3">
              <h3 className="text-base font-bold text-primary mb-0.5">CUSTOM</h3>
              <h3 className="text-base font-bold text-primary mb-0.5">ANNOTATION</h3>
              <h3 className="text-base font-bold text-primary">DESIGN</h3>
            </div>
          ...
          <div className="bg-white text-primary rounded-lg p-4 w-full lg:w-72 h-96 relative flex flex-col">
            <div className="text-center mb-3">
              <h3 className="text-base font-bold text-primary mb-0.5">FUTURE-PROOFED</h3>
              <h3 className="text-base font-bold text-primary mb-0.5">DATA</h3>
              <h3 className="text-base font-bold text-primary">ARCHITECTURE</h3>
            </div>
          ...
          <div className="bg-white text-primary rounded-lg p-4 w-full lg:w-72 h-96 relative flex flex-col">
            <div className="text-center mb-3">
              <h3 className="text-base font-bold text-primary mb-0.5">HUMAN IN THE</h3>
              <h3 className="text-base font-bold text-primary mb-0.5">LOOP,</h3>
              <h3 className="text-base font-bold text-primary">ALWAYS</h3>
            </div>
          ...
          <div className="bg-primary border-4 border-white rounded-lg p-4 w-full lg:w-72 h-96 relative flex flex-col">
            ...
            <div className="text-center flex-grow flex flex-col justify-center">
              <p className="text-accent text-xs font-medium leading-relaxed">
