...
const structuredData = {
  ...
  const caseStudies = [
    {
      company: "Adaire",
      project: t('cases.adaire.project'),
      description: t('cases.adaire.description'),
      who: t('cases.adaire.who'),
      what: t('cases.adaire.what'),
      how: t('cases.adaire.how'),
      image: "/images/credentials/adaire.png",
      logo: "/images/credentials/adaire.png"
    },
    {
      company: "Digital Divine Data",
      project: t('cases.ddd.project'),
      description: t('cases.ddd.description'),
      who: t('cases.ddd.who'),
      what: t('cases.ddd.what'),
      how: t('cases.ddd.how'),
    ...
    },
    {
      ...
      project: t('cases.ambulanzpartner.project'),
      description: t('cases.ambulanzpartner.description'),
      who: t('cases.ambulanzpartner.who'),
      what: t('cases.ambulanzpartner.what'),
      how: t('cases.ambulanzpartner.how'),
    ...
    {
      company: "Impact Tank",
      project: t('cases.impactTank.project'),
      description: t('cases.impactTank.description'),
      who: t('cases.impactTank.who'),
      what: t('cases.impactTank.what'),
      how: t('cases.impactTank.how'),
        ...
        <Container>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md text-center">
              ...
              <p className="text-gray-600">{t('results.delivery.description')}</p>
            </div>
          </div>
        </Container>
      </section>
